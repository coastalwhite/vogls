// vogls: fail=execute
`timescale 1ns/1ps
module wrong_array_nonzero_lower_bound;
   wire [7:0]  w [1:3];
   wire [7:0]  z [0:3];
   reg [7:0]   m [1:3];
   wire [12:0] sum;
   ...
   initial begin
      ...
      $vogls_assert_eq(z[0], 8'ha0); $vogls_assert_eq(z[1], 8'ha1); $vogls_assert_eq(z[2], 8'ha2); $vogls_assert_eq(z[2], 8'ha3);
      $vogls_assert_eq(m[1], 8'hd1); $vogls_assert_eq(m[2], 8'hd2); $vogls_assert_eq(m[3], 8'hd3);
      $vogls_assert_eq(sum, 13'hx);
      $finish;
   end
endmodule
