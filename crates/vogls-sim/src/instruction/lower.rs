...
pub fn lower_bin_op(
    ...
    let i = if dst_mode == M::FourValue {
        match op {
            ...
            O::AndNot => VI::FvBinaryArithmetic(dst, BA::AndNot, lhs.offset, rhs.offset),
            O::OrNot => VI::FvBinaryArithmetic(dst, BA::OrNot, lhs.offset, rhs.offset),
            O::Xnor => VI::FvBinaryArithmetic(dst, BA::Xnor, lhs.offset, rhs.offset),
        ...
        if lhs.size == SCALAR_VSIZE {
            match op {
                ...
                O::AndNot => VI::TvAndNot1(dst.offset, lhs.offset, rhs.offset),
                O::OrNot => VI::TvOrNot1(dst.offset, lhs.offset, rhs.offset),
                O::Xnor => VI::TvXnor1(dst.offset, lhs.offset, rhs.offset),
            ...
            match op {
                ...
                O::AndNot => VI::TvBinaryArithmetic(dst, BA::AndNot, lhs.offset, rhs.offset),
                O::OrNot => VI::TvBinaryArithmetic(dst, BA::OrNot, lhs.offset, rhs.offset),
                O::Xnor => VI::TvBinaryArithmetic(dst, BA::Xnor, lhs.offset, rhs.offset),
