...
`endif
		...
		$vogls_assert_eq(7'h00 - 7'h7f, 7'h01);
		$vogls_assert_eq(7'h7f - 7'h00, 7'h7f);
		$vogls_assert_eq(7'h7f - 7'h7f, 7'h00);
		$vogls_assert_eq(7'h1a - 7'h17, 7'h03);
		$vogls_assert_eq(7'h61 - 7'h18, 7'h49);
		$vogls_assert_eq(7'h5b - 7'h58, 7'h03);
		$vogls_assert_eq(7'h43 - 7'h0b, 7'h38);
		$vogls_assert_eq(7'h75 - 7'h1f, 7'h56);
		$vogls_assert_eq(7'h60 - 7'h14, 7'h4c);
		$vogls_assert_eq(7'h4b - 7'h5c, 7'h6f);
		$vogls_assert_eq(7'h31 - 7'h11, 7'h20);
`ifndef __VOGLS__TWO_VALUE_LOGIC
...
`endif
		...
		$vogls_assert_eq(31'h0000_0000 - 31'h7fff_ffff, 31'h0000_0001);
		$vogls_assert_eq(31'h7fff_ffff - 31'h0000_0000, 31'h7fff_ffff);
		$vogls_assert_eq(31'h7fff_ffff - 31'h7fff_ffff, 31'h0000_0000);
		$vogls_assert_eq(31'h5cab_cc97 - 31'h3825_67b8, 31'h2486_64df);
		$vogls_assert_eq(31'h2369_b584 - 31'h7e57_0ddf, 31'h2512_a7a5);
		$vogls_assert_eq(31'h1745_d6d8 - 31'h0c0f_d195, 31'h0b36_0543);
		$vogls_assert_eq(31'h1c11_f735 - 31'h2720_9bdf, 31'h74f1_5b56);
		$vogls_assert_eq(31'h28f4_9481 - 31'h6c12_ace8, 31'h3ce1_e799);
		$vogls_assert_eq(31'h1043_5a10 - 31'h6280_1c45, 31'h2dc3_3dcb);
		$vogls_assert_eq(31'h61b1_cd22 - 31'h77d2_1e02, 31'h69df_af20);
		$vogls_assert_eq(31'h405c_acec - 31'h02f0_6b90, 31'h3d6c_415c);
`ifndef __VOGLS__TWO_VALUE_LOGIC
...
`endif
		...
		$vogls_assert_eq(32'h0000_0000 - 32'hffff_ffff, 32'h0000_0001);
		$vogls_assert_eq(32'hffff_ffff - 32'h0000_0000, 32'hffff_ffff);
		$vogls_assert_eq(32'hffff_ffff - 32'hffff_ffff, 32'h0000_0000);
		$vogls_assert_eq(32'hfad4_09e2 - 32'hb4a6_9f3c, 32'h462d_6aa6);
		$vogls_assert_eq(32'h8f97_97b0 - 32'h1ca3_c448, 32'h72f3_d368);
		$vogls_assert_eq(32'h8d72_48e2 - 32'h6e06_8097, 32'h1f6b_c84b);
		$vogls_assert_eq(32'h0ab5_4bde - 32'h5b99_62c6, 32'haf1b_e918);
		$vogls_assert_eq(32'hae9b_ec36 - 32'haabc_25fa, 32'h03df_c63c);
		$vogls_assert_eq(32'hdfed_2c43 - 32'hbfdd_c3d9, 32'h200f_686a);
		$vogls_assert_eq(32'h698c_206f - 32'hecab_3301, 32'h7ce0_ed6e);
		$vogls_assert_eq(32'h3f87_e362 - 32'hb386_f7a4, 32'h8c00_ebbe);
`ifndef __VOGLS__TWO_VALUE_LOGIC
...
`endif
		...
		$vogls_assert_eq(33'h0_0000_0000 - 33'h1_ffff_ffff, 33'h0_0000_0001);
		$vogls_assert_eq(33'h1_ffff_ffff - 33'h0_0000_0000, 33'h1_ffff_ffff);
		$vogls_assert_eq(33'h1_ffff_ffff - 33'h1_ffff_ffff, 33'h0_0000_0000);
		$vogls_assert_eq(33'h0_5e6f_ea07 - 33'h0_b7e6_427c, 33'h1_a689_a78b);
		$vogls_assert_eq(33'h0_4fa0_3f26 - 33'h0_9424_aed5, 33'h1_bb7b_9051);
		$vogls_assert_eq(33'h1_edcb_8cb6 - 33'h1_6014_1de9, 33'h0_8db7_6ecd);
		$vogls_assert_eq(33'h0_32c5_bd89 - 33'h0_3e2b_6091, 33'h1_f49a_5cf8);
		$vogls_assert_eq(33'h0_ce37_14af - 33'h1_0a83_81be, 33'h1_c3b3_92f1);
		$vogls_assert_eq(33'h1_8861_fe18 - 33'h1_a959_7663, 33'h1_df08_87b5);
		$vogls_assert_eq(33'h1_a5c5_650c - 33'h0_7d7d_dbed, 33'h1_2847_891f);
		$vogls_assert_eq(33'h1_272a_6d8e - 33'h1_a684_6099, 33'h1_80a6_0cf5);
`ifndef __VOGLS__TWO_VALUE_LOGIC
...
`endif
		...
		$vogls_assert_eq(63'h0000_0000_0000_0000 - 63'h7fff_ffff_ffff_ffff, 63'h0000_0000_0000_0001);
		...
		$vogls_assert_eq(63'h49bc_473f_ed7b_f656 - 63'h7c16_128d_b2c0_8394, 63'h4da6_34b2_3abb_72c2);
		$vogls_assert_eq(63'h0763_fcd0_1f15_c7b6 - 63'h4f8d_5238_288b_78b5, 63'h37d6_aa97_f68a_4f01);
		$vogls_assert_eq(63'h0380_2b70_8d03_c91e - 63'h6872_13f9_8d60_5936, 63'h1b0e_1776_ffa3_6fe8);
		$vogls_assert_eq(63'h3985_fb62_17dc_8eff - 63'h1d0b_c9bd_e9b5_c5cf, 63'h1c7a_31a4_2e26_c930);
		$vogls_assert_eq(63'h276a_a6ce_d507_55d9 - 63'h4ab7_706e_b773_50ca, 63'h5cb3_3660_1d94_050f);
		$vogls_assert_eq(63'h6a5d_932b_45ff_2c83 - 63'h7b85_179a_d5b0_77e0, 63'h6ed8_7b90_704e_b4a3);
		$vogls_assert_eq(63'h78e3_654b_faf1_4ff0 - 63'h74ef_f545_3e65_2603, 63'h03f3_7006_bc8c_29ed);
		$vogls_assert_eq(63'h2507_4181_8d1f_b540 - 63'h30cb_d755_6232_b17a, 63'h743b_6a2c_2aed_03c6);
`ifndef __VOGLS__TWO_VALUE_LOGIC
...
`endif
		...
		$vogls_assert_eq(64'h0000_0000_0000_0000 - 64'hffff_ffff_ffff_ffff, 64'h0000_0000_0000_0001);
		...
		$vogls_assert_eq(64'h2112_507c_2cfa_55b0 - 64'hb423_ccde_8857_5117, 64'h6cee_839d_a4a3_0499);
		$vogls_assert_eq(64'hce63_22b6_ab05_347f - 64'h0ad4_5230_bdf6_6ba5, 64'hc38e_d085_ed0e_c8da);
		$vogls_assert_eq(64'hdcb3_3df3_13ee_cdc6 - 64'h4a1d_ab32_6aed_fdc7, 64'h9295_92c0_a900_cfff);
		$vogls_assert_eq(64'h9e3d_750d_f296_d9f0 - 64'h168f_ae12_5ca2_60c9, 64'h87ad_c6fb_95f4_7927);
		$vogls_assert_eq(64'h1b19_d8b8_d830_2081 - 64'h96c0_44d0_6f88_7f28, 64'h8459_93e8_68a7_a159);
		$vogls_assert_eq(64'h1422_373f_8622_68d1 - 64'h38b8_f24e_56ea_57b3, 64'hdb69_44f1_2f38_111e);
		$vogls_assert_eq(64'h2b0a_bedd_c774_44cb - 64'ha21b_0307_82af_085c, 64'h88ef_bbd6_44c5_3c6f);
		$vogls_assert_eq(64'h828c_37e7_87d5_b7be - 64'hc6b6_e4ad_e7ea_8d5a, 64'hbbd5_5339_9feb_2a64);
`ifndef __VOGLS__TWO_VALUE_LOGIC
...
`endif
		...
		$vogls_assert_eq(65'h0_0000_0000_0000_0000 - 65'h1_ffff_ffff_ffff_ffff, 65'h0_0000_0000_0000_0001);
		$vogls_assert_eq(65'h1_ffff_ffff_ffff_ffff - 65'h0_0000_0000_0000_0000, 65'h1_ffff_ffff_ffff_ffff);
		$vogls_assert_eq(65'h1_ffff_ffff_ffff_ffff - 65'h1_ffff_ffff_ffff_ffff, 65'h0_0000_0000_0000_0000);
		$vogls_assert_eq(65'h0_a394_ed54_9e3c_5a88 - 65'h1_4d56_0a3d_f4e7_069a, 65'h1_563e_e316_a955_53ee);
		$vogls_assert_eq(65'h1_67f5_ae02_af5b_8f47 - 65'h1_2877_f5d9_0f56_75f8, 65'h0_3f7d_b829_a005_194f);
		$vogls_assert_eq(65'h1_7bf7_e1d3_6a66_2fce - 65'h1_dc5b_e7d1_fcef_1972, 65'h1_9f9b_fa01_6d77_165c);
		$vogls_assert_eq(65'h0_6612_4ab4_f9b2_1e6e - 65'h1_1b2e_dedb_8fc8_5fc0, 65'h1_4ae3_6bd9_69e9_beae);
		$vogls_assert_eq(65'h0_776a_bf09_3de2_8859 - 65'h0_7318_b96d_4479_0612, 65'h0_0452_059b_f969_8247);
		$vogls_assert_eq(65'h0_18c8_a616_2410_8e9a - 65'h1_f204_be89_4a4b_5563, 65'h0_26c3_e78c_d9c5_3937);
		$vogls_assert_eq(65'h1_9d89_6047_dd39_d793 - 65'h0_500e_15c0_b89b_df7f, 65'h1_4d7b_4a87_249d_f814);
		$vogls_assert_eq(65'h1_28ca_aa1d_c35b_ec2c - 65'h1_83c5_01cb_fef7_d9ea, 65'h1_a505_a851_c464_1242);
`ifndef __VOGLS__TWO_VALUE_LOGIC
...
`endif
		...
		$vogls_assert_eq(127'h0000_0000_0000_0000_0000_0000_0000_0000 - 127'h7fff_ffff_ffff_ffff_ffff_ffff_ffff_ffff, 127'h0000_0000_0000_0000_0000_0000_0000_0001);
		...
		$vogls_assert_eq(127'h7f4d_908c_e1ff_f6c0_8347_f1da_5c11_ab6d - 127'h5ee6_8495_3400_29c3_ea11_905b_51fa_cefa, 127'h2067_0bf7_adff_ccfc_9936_617f_0a16_dc73);
		$vogls_assert_eq(127'h255b_30e2_bdc2_b74b_38a5_6b49_dd34_aa18 - 127'h6ae6_6582_b852_b3cd_9442_b5e6_9583_1d58, 127'h3a74_cb60_0570_037d_a462_b563_47b1_8cc0);
		$vogls_assert_eq(127'h5472_0d2d_3239_9ffb_2704_6f25_4b91_b8cb - 127'h41e0_2a89_566a_9ce7_af52_1b94_f186_e47a, 127'h1291_e2a3_dbcf_0313_77b2_5390_5a0a_d451);
		$vogls_assert_eq(127'h7d97_ac0f_bd56_09c4_a446_1663_b93b_17fb - 127'h08a8_ac7f_8621_38ad_0f09_105c_f50d_7a37, 127'h74ee_ff90_3734_d117_953d_0606_c42d_9dc4);
		$vogls_assert_eq(127'h7ce4_0679_a8c6_dbc0_7bb3_447b_e9aa_144b - 127'h1b65_6dab_2de4_6e91_e8e6_e840_f090_f5a0, 127'h617e_98ce_7ae2_6d2e_92cc_5c3a_f919_1eab);
		$vogls_assert_eq(127'h261e_2555_863e_1f2a_18a8_06ef_eb05_3fc4 - 127'h446f_64dd_5abc_a6e5_d0b1_e3eb_409e_7a80, 127'h61ae_c078_2b81_7844_47f6_2304_aa66_c544);
		$vogls_assert_eq(127'h5f80_4eeb_143a_9aff_659b_0105_cb80_f288 - 127'h39d1_c7ff_b27e_1442_fd7f_e973_3e42_df5b, 127'h25ae_86eb_61bc_86bc_681b_1792_8d3e_132d);
		$vogls_assert_eq(127'h17ef_a621_081c_79d4_c274_37eb_a65f_7b8a - 127'h026b_5383_a301_ec03_0e5d_8c6a_79db_7862, 127'h1584_529d_651a_8dd1_b416_ab81_2c84_0328);
`ifndef __VOGLS__TWO_VALUE_LOGIC
...
`endif
		...
		$vogls_assert_eq(128'h0000_0000_0000_0000_0000_0000_0000_0000 - 128'hffff_ffff_ffff_ffff_ffff_ffff_ffff_ffff, 128'h0000_0000_0000_0000_0000_0000_0000_0001);
		...
		$vogls_assert_eq(128'h7d8d_3ddd_2cf1_49cb_4f1e_1a37_8ac8_ad93 - 128'h9a06_9295_3b8d_3447_0e61_065f_171b_1b80, 128'he386_ab47_f164_1584_40bd_13d8_73ad_9213);
		$vogls_assert_eq(128'h002c_cb25_7a5d_7c82_86c5_547c_051a_0039 - 128'hce73_34f2_3393_2b6c_9d37_efb6_eafb_3e90, 128'h31b9_9633_46ca_5115_e98d_64c5_1a1e_c1a9);
		$vogls_assert_eq(128'h0f3f_0f48_52d6_b779_de43_79cb_d823_0076 - 128'heacf_33a9_b466_fab6_962c_04dd_25d0_7461, 128'h246f_db9e_9e6f_bcc3_4817_74ee_b252_8c15);
		$vogls_assert_eq(128'h9605_3035_6545_c030_a981_fa54_f121_e129 - 128'ha630_ad9d_7cb9_23f5_f5ed_f382_a3a6_ef83, 128'hefd4_8297_e88c_9c3a_b394_06d2_4d7a_f1a6);
		$vogls_assert_eq(128'hc978_4b52_9d1c_0838_edc8_cca8_e3bc_d6f3 - 128'hd080_12b8_96c5_6fe7_aa60_4892_3926_12e9, 128'hf8f8_389a_0656_9851_4368_8416_aa96_c40a);
		$vogls_assert_eq(128'hb041_6f19_bbe7_1835_4e8b_f78a_60dd_c7f1 - 128'h9146_8cdc_f716_4b73_c555_23ed_fe89_56c8, 128'h1efa_e23c_c4d0_ccc1_8936_d39c_6254_7129);
		$vogls_assert_eq(128'h2401_342a_7f05_fbf5_efca_c577_1aa6_f7cb - 128'h7256_56e3_55f3_ad50_e2fb_b984_bab2_7bce, 128'hb1aa_dd47_2912_4ea5_0ccf_0bf2_5ff4_7bfd);
		$vogls_assert_eq(128'hb173_fcdf_3fe1_e8f3_35ad_de88_43e4_f668 - 128'he271_fff9_2a95_27f6_f817_0ebf_6b6e_64c5, 128'hcf01_fce6_154c_c0fc_3d96_cfc8_d876_91a3);
`ifndef __VOGLS__TWO_VALUE_LOGIC
...
`endif
		...
		$vogls_assert_eq(129'h0_0000_0000_0000_0000_0000_0000_0000_0000 - 129'h1_ffff_ffff_ffff_ffff_ffff_ffff_ffff_ffff, 129'h0_0000_0000_0000_0000_0000_0000_0000_0001);
		...
		$vogls_assert_eq(129'h1_ffff_ffff_ffff_ffff_ffff_ffff_ffff_ffff - 129'h1_ffff_ffff_ffff_ffff_ffff_ffff_ffff_ffff, 129'h0_0000_0000_0000_0000_0000_0000_0000_0000);
		$vogls_assert_eq(129'h1_98be_5ff0_929d_af9f_0149_a2af_0ab1_a504 - 129'h1_15ca_dfaf_f26d_3dd3_8c2a_a0b1_8982_cbf8, 129'h0_82f3_8040_a030_71cb_751f_01fd_812e_d90c);
		$vogls_assert_eq(129'h0_2934_4e15_2477_f047_8336_a758_d9f9_3502 - 129'h0_40b3_af7c_d5b2_11a9_9dec_2b83_3885_8f7e, 129'h1_e880_9e98_4ec5_de9d_e54a_7bd5_a173_a584);
		$vogls_assert_eq(129'h0_abf3_9096_4a68_369c_12b9_9a50_8cb6_d1f0 - 129'h0_5b6d_6b7c_54b2_a582_f398_1e9e_7cb8_82a0, 129'h0_5086_2519_f5b5_9119_1f21_7bb2_0ffe_4f50);
		$vogls_assert_eq(129'h1_199c_8d94_3c0a_584e_a7cd_13cb_abda_06b2 - 129'h1_3189_1f48_e66e_2c11_11de_febf_9e98_961d, 129'h1_e813_6e4b_559c_2c3d_95ee_150c_0d41_7095);
		$vogls_assert_eq(129'h0_502e_d818_013c_a998_2b2b_f58c_6da5_8dad - 129'h0_5c07_4653_d711_73e4_46d4_7d41_6fa5_d3b0, 129'h1_f427_91c4_2a2b_35b3_e457_784a_fdff_b9fd);
		$vogls_assert_eq(129'h1_e0bd_202c_54e1_4f3a_bba4_1ae0_adf8_f767 - 129'h1_c657_20ae_5bd6_7d4d_7202_fae5_767d_3b27, 129'h0_1a65_ff7d_f90a_d1ed_49a1_1ffb_377b_bc40);
		$vogls_assert_eq(129'h0_89e2_df24_e42c_0aea_23d7_263d_d391_d017 - 129'h0_a06a_187d_e2e6_e7a6_bbc9_9473_4363_589c, 129'h1_e978_c6a7_0145_2343_680d_91ca_902e_777b);
		$vogls_assert_eq(129'h0_970c_9eb4_c4ea_4ece_67b6_e467_9432_d797 - 129'h0_647a_c591_5da6_4a3a_260c_cfb4_c673_5380, 129'h0_3291_d923_6744_0494_41aa_14b2_cdbf_8417);
`ifndef __VOGLS__TWO_VALUE_LOGIC
